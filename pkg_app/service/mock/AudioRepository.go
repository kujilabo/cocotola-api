...
// AddAudio provides a mock function with given fields: ctx, lang, text, audioContent
func (_m *AudioRepository) AddAudio(ctx context.Context, lang domain.Lang5, text string, audioContent string) (domain.AudioID, error) {
	ret := _m.Called(ctx, lang, text, audioContent)

	var r0 domain.AudioID
	if rf, ok := ret.Get(0).(func(context.Context, domain.Lang5, string, string) domain.AudioID); ok {
		r0 = rf(ctx, lang, text, audioContent)
	} else {
	...
	if rf, ok := ret.Get(1).(func(context.Context, domain.Lang5, string, string) error); ok {
		r1 = rf(ctx, lang, text, audioContent)
	} else {
		r1 = ret.Error(1)
	}
...
// FindAudioIDByText provides a mock function with given fields: ctx, lang, text
func (_m *AudioRepository) FindAudioIDByText(ctx context.Context, lang domain.Lang5, text string) (domain.AudioID, error) {
...
// FindByLangAndText provides a mock function with given fields: ctx, lang, text
func (_m *AudioRepository) FindByLangAndText(ctx context.Context, lang domain.Lang5, text string) (service.Audio, error) {
	ret := _m.Called(ctx, lang, text)
