...
import (
	...
	pkg_appdomain "github.com/kujilabo/cocotola-api/pkg_app/domain"
...
func (_m *WorkbookRepository) AddWorkbook(ctx context.Context, operator domain.AppUserModel, spaceID domain.SpaceID, param service.WorkbookAddParameter) (pkg_appdomain.WorkbookID, error) {
	ret := _m.Called(ctx, operator, spaceID, param)

	var r0 pkg_appdomain.WorkbookID
	if rf, ok := ret.Get(0).(func(context.Context, domain.AppUserModel, domain.SpaceID, service.WorkbookAddParameter) pkg_appdomain.WorkbookID); ok {
		r0 = rf(ctx, operator, spaceID, param)
	} else {
		r0 = ret.Get(0).(pkg_appdomain.WorkbookID)
	}
...
func (_m *WorkbookRepository) FindPersonalWorkbooks(ctx context.Context, operator pkg_appdomain.StudentModel, param service.WorkbookSearchCondition) (service.WorkbookSearchResult, error) {
	ret := _m.Called(ctx, operator, param)

	var r0 service.WorkbookSearchResult
	if rf, ok := ret.Get(0).(func(context.Context, pkg_appdomain.StudentModel, service.WorkbookSearchCondition) service.WorkbookSearchResult); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, pkg_appdomain.StudentModel, service.WorkbookSearchCondition) error); ok {
...
func (_m *WorkbookRepository) FindWorkbookByID(ctx context.Context, operator pkg_appdomain.StudentModel, id pkg_appdomain.WorkbookID) (service.Workbook, error) {
	ret := _m.Called(ctx, operator, id)

	var r0 service.Workbook
	if rf, ok := ret.Get(0).(func(context.Context, pkg_appdomain.StudentModel, pkg_appdomain.WorkbookID) service.Workbook); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, pkg_appdomain.StudentModel, pkg_appdomain.WorkbookID) error); ok {
...
func (_m *WorkbookRepository) RemoveWorkbook(ctx context.Context, operator pkg_appdomain.StudentModel, workbookID pkg_appdomain.WorkbookID, version int) error {
	ret := _m.Called(ctx, operator, workbookID, version)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, pkg_appdomain.StudentModel, pkg_appdomain.WorkbookID, int) error); ok {
...
func (_m *WorkbookRepository) UpdateWorkbook(ctx context.Context, operator pkg_appdomain.StudentModel, workbookID pkg_appdomain.WorkbookID, version int, param service.WorkbookUpdateParameter) error {
	ret := _m.Called(ctx, operator, workbookID, version, param)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, pkg_appdomain.StudentModel, pkg_appdomain.WorkbookID, int, service.WorkbookUpdateParameter) error); ok {
