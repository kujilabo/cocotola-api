...
type Translator interface {
	...
	FindTranslationByText(ctx context.Context, lang app.Lang2, text string) ([]domain.Translation, error)
...
func (t *translator) selectMaxConfidenceTranslations(ctx context.Context, in []AzureTranslation) (map[domain.WordPos]AzureTranslation, error) {
	results := make(map[domain.WordPos]AzureTranslation)
	for _, i := range in {
...
func (t *translator) customDictionaryLookup(ctx context.Context, text string, fromLang, toLang app.Lang2) ([]domain.Translation, error) {
...
func (t *translator) DictionaryLookup(ctx context.Context, fromLang, toLang app.Lang2, text string) ([]domain.Translation, error) {
...
func (t *translator) DictionaryLookupWithPos(ctx context.Context, fromLang, toLang app.Lang2, text string, pos domain.WordPos) (domain.Translation, error) {
...
func (t *translator) FindTranslationsByFirstLetter(ctx context.Context, lang app.Lang2, firstLetter string) ([]domain.Translation, error) {
	customRepo, err := t.rf.NewCustomTranslationRepository(ctx)
	if err != nil {
		return nil, err
	}
...
func (t *translator) FindTranslationByTextAndPos(ctx context.Context, lang app.Lang2, text string, pos domain.WordPos) (domain.Translation, error) {
	customRepo, err := t.rf.NewCustomTranslationRepository(ctx)
	if err != nil {
		return nil, err
	}
...
func (t *translator) FindTranslationByText(ctx context.Context, lang app.Lang2, text string) ([]domain.Translation, error) {
...
func (t *translator) UpdateTranslation(ctx context.Context, lang app.Lang2, text string, pos domain.WordPos, param TranslationUpdateParameter) error {
	customRepo, err := t.rf.NewCustomTranslationRepository(ctx)
	if err != nil {
		return err
	}
...
func (t *translator) RemoveTranslation(ctx context.Context, lang app.Lang2, text string, pos domain.WordPos) error {
	customRepo, err := t.rf.NewCustomTranslationRepository(ctx)
	if err != nil {
		return err
	}
