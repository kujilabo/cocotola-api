...
func (r *customTranslationRepository) Update(ctx context.Context, lang app.Lang2, text string, pos domain.WordPos, param service.TranslationUpdateParameter) error {
